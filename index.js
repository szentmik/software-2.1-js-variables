...
console.log(studentFirstName + " " + studentLastName + " has an average grade of " + average + " ex. Jane Doe has an average grade of 100.");
//4. Write code that would answer this question: Did the student pass?
console.log("Did the student pass? ", average > passingGrade);